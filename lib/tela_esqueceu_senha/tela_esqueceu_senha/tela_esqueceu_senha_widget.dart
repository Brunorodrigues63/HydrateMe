...
import 'tela_esqueceu_senha_model.dart';
export 'tela_esqueceu_senha_model.dart';

class TelaEsqueceuSenhaWidget extends StatefulWidget {
  const TelaEsqueceuSenhaWidget({super.key});

  static String routeName = 'TelaEsqueceuSenha';
  static String routePath = '/telaEsqueceuSenha';

  @override
  State<TelaEsqueceuSenhaWidget> createState() =>
      _TelaEsqueceuSenhaWidgetState();
}

class _TelaEsqueceuSenhaWidgetState extends State<TelaEsqueceuSenhaWidget> {
  late TelaEsqueceuSenhaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TelaEsqueceuSenhaModel());
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(10.0, 5.0, 0.0, 20.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text(
                            'Informe um e-mail para a recuperação',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              await launchUrl(Uri(
                                  scheme: 'mailto',
                                  path: 'hydratemeltda@gmail.com',
                                  query: {
                                    'subject': 'Código de recuperação de senha',
                                    'body':
                                        'Código para recuperar senha: 563201',
                                  }
                                      .entries
