...
class BackendException implements Exception {
  ...
  factory BackendException.dioException({required DioException error}) {
    return _handleDioException(error);
  }

  factory BackendException.otherException() {
    return _handleOtherException();
  }

  static BackendException _handleOtherException() {
    return BackendException("Ops, alguma coisa deu errado :(");
  }

  static BackendException _handleDioException(DioException error) {
    switch (error.type) {
      case DioExceptionType.cancel:
        return BackendException("Requisição cancelada");
      case DioExceptionType.connectionTimeout:
        return BackendException("Não consegui conectar no servidor...");
      case DioExceptionType.receiveTimeout:
        return BackendException("Servidor demorou muito para responder...");
