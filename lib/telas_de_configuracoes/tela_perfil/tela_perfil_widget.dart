...
class TelaPerfilWidget extends StatefulWidget {
  ...
  static String routePath = '/telaPerfil';
...
class _TelaPerfilWidgetState extends State<TelaPerfilWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(text: 'Bruno Rodrigues');
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??=
        TextEditingController(text: 'Mateus.Teste@gmail.com');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadDataVk4 = true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadDataVk4 =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadDataVk4 =
                                  ...
                                  if (selectedMedia != null &&
                                      selectedMedia.every((m) =>
                                          validateFileFormat(
                                              m.storagePath, context))) {
                                    safeSetState(() => _model
                                        .isDataUploading_uploadDataJz2 = true);
                                    var selectedUploadedFiles =
                                        <FFUploadedFile>[];
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadDataJz2 =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadDataJz2 =
                                            selectedUploadedFiles.first;
                                      });
                                    } else {
                                      safeSetState(() {});
